...
export default function ToolPanel({ disabled }: { disabled: boolean }) {
  ...
  const btn  = "flex-1 px-2 py-2 rounded bg-neutral-900 border border-neutral-800 text-xs disabled:opacity-40 hover:bg-neutral-800 transition-colors";
  const wbtn = "w-full px-3 py-2 rounded bg-neutral-900 border border-neutral-800 text-xs disabled:opacity-40 hover:bg-neutral-800 transition-colors";
      ...
      <div className="p-3 md:p-4 grid grid-cols-2 md:grid-cols-1 gap-3">
        ...
        <div className="col-span-2 md:col-span-1 space-y-1.5">
          ...
          <button
            ...
            onClick={paste}
            className="w-full px-3 py-2 rounded bg-indigo-600 hover:bg-indigo-500 text-xs disabled:opacity-40 transition-colors"
          >
            Paste at Playhead
          </button>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-[10px] text-neutral-400">{repClip?.edits.gain ?? 0} dB</p>
          <div className="flex gap-1.5">
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-[10px] text-neutral-400">{repClip?.edits.pan ?? 0}</p>
          <div className="flex gap-1.5">
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-[10px] text-neutral-400">{repClip?.edits.playbackRate ?? 1}×</p>
          <div className="flex gap-1.5">
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-[10px] text-neutral-400">{repClip?.edits.pitch ?? 0} st</p>
          <div className="flex gap-1.5">
        ...
        <div className="col-span-2 md:col-span-1 space-y-1.5">
          ...
          <button
            disabled={!canEdit}
            onClick={remove}
            className="w-full px-3 py-2 rounded bg-red-900/40 border border-red-800 text-xs disabled:opacity-40 hover:bg-red-900/60 transition-colors"
          >
            Delete Region
          </button>
        </div>
        ...
        <div className="col-span-2 md:col-span-1 space-y-2">
          ...
          <div className="flex gap-1.5">
            ...
            <label className="flex items-center gap-1.5 px-2 py-2 rounded bg-neutral-900 border border-neutral-800 text-xs cursor-pointer">
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="flex-1 accent-indigo-500"
            />
            <span className="text-[10px] text-neutral-400 w-10 text-right flex-shrink-0">
