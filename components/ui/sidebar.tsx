...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-[98%] my-auto ml-2 px-4 py-4 hidden  md:flex md:flex-col    rounded-2xl bg-neutral-100 dark:bg-neutral-800 w-[300px] shrink-0",
          className
        )}
        animate={{
    ...
    <>
      <div
          className={cn(
            ...
            "border-b border-violet-400/70 shadow-[0_6px_16px_-3px_rgba(139,92,246,0.35)]",
            "dark:border-violet-400/60 dark:shadow-[0_6px_24px_-2px_rgba(167,139,250,0.7)]"
          )}
        {...props}
      >
