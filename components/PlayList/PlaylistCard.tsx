...
export default function PlaylistCard({ playlist }: { playlist: Playlist }) {
  return (
    <div
      className="group relative w-64 min-w-[16rem] bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-transparent
                 hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-colors rounded-xl cursor-pointer overflow-hidden
