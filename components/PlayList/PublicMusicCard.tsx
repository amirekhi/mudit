...
export default function PublicMusicCard({ track }: PublicMusicCardProps) {
  ...
  return (
    <motion.div
      ...
      className="group relative w-72 min-w-[280px] h-72 bg-neutral-900 rounded-2xl p-4
        flex flex-col justify-between cursor-pointer shadow-xl hover:shadow-2xl
    ...
    >
      ...
      <Link
        ...
        className="absolute top-2 right-2 p-1.5 rounded-lg bg-black/50 text-neutral-400
